!function (t, e) {
    ...
    return function (t) {
        ...
        var h = i(1), c = h.isOnServer, a = h.isInBrowser, l = h.eventTypes, p = i(3), u = !1;
        if (a) try {
        ...
        var d = !!u && {capture: !1, passive: !0}, f = function () {
            function t(e, i) {
                function h() {
        ...
        var s = i(1), n = s.VISIBILITYCHANGE, r = s.ENTERVIEWPORT, h = s.FULLYENTERVIEWPORT, c = s.EXITVIEWPORT,
            a = s.PARTIALLYEXITVIEWPORT, l = s.LOCATIONCHANGE, p = s.STATECHANGE, u = s.eventTypes,
            w = s.defaultOffsets;
        o.prototype = {
            on: function (t, e, i) {
                switch (!0) {
