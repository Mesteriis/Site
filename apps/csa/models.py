...
class custumers_1c_avto(models.Model):
    ...
    inn = models.IntegerField(max_length=12, blank=False, verbose_name='')
    kpp = models.IntegerField(max_length=9, blank=True, verbose_name='')
    avto = models.CharField (blank=False, verbose_name="Автомобиль")
    a_number = models.CharField (blank=False, verbose_name="Номер")
    id_1c = models.CharField (blank=False, verbose_name="ID", index=True)
    ...
    num_last_nach = models.CharField(blank=True, verbose_name='Номер п.н.')
    ...
    num_last_pay = models.CharField(blank=True, verbose_name='Номер п.с.')
