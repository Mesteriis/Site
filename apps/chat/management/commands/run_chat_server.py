...
from privateChat import channels, handlers
from privateChat.utils import logger
import sys
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        tmp = 'Host '+ str(settings.CHAT_WS_SERVER_HOST) + 'Port ' + str(settings.CHAT_WS_SERVER_PORT)
...
if settings.CHAT_SERVER_STARTUP:
    print('startUp Chat ')
    chat = Command()
